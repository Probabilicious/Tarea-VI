	...
	$$M_{x}(t)^{(n+1)}=(M_{x}(t)^{(n)})^{(1)}=(\frac{\lambda (n!)}{(\lambda-t)^{n+1}})^{(1)}=\frac{\lambda (n+1)(n!)}{(\lambda-t)^{n+2}}=\frac{\lambda (n+1)!}{(\lambda-t)^{n+2}}$$ Entonces la afirmación es correcta. Entonces, tenemos que $$E(X^{k})=\lim_{t\rightarrow 0}(M_{x}(t))^{(k)}=\lim_{t \rightarrow 0}(\frac{\lambda(k!)}{(\lambda-t)^{k+1}})=\frac{\lambda k!}{\lambda^{k+1}}=\frac{k!}{\lambda^{k}}_{\blacksquare}$$
		...
		\item{
		    ...
		    \item {
                    ...
                    Para que el funcion sea simetrica se quiere demostrar que f($\mu - x$) = f($\mu + x$). Pero se puede demostrar que:
                    \[\frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(\mu - x - \mu)^2}{2\sigma^2}} = \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(\mu + x - \mu)^2}{2\sigma^2}}\]
                    \[ \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(- x)^2}{2\sigma^2}} = \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(x)^2}{2\sigma^2}}\]
                     \[ \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{x^2}{2\sigma^2}} = \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{x^2}{2\sigma^2}}\]
                     Que se puede notar que obviamente son iguales, entonces es simetrica. Sabemos que $\mu$ es el maximo ya que cuando x tiene cualquier valor diferente de $\mu$:
                     \[-\frac{(x - \mu)^2}{2\sigma^2} \neq 0\]
                     Y como cuando $x = \mu$ resulta en que la funcion es igual a:
                     \[\frac{1}{\sigma\sqrt{2\pi}}\]
                     Esto es el maximo valor que puede tomar la funcion, entonces tiene un maximo en $x = \mu$.
                     \\ Cuando x_1 = $\mu - \sigma$ y $x_2 = \mu + \sigma$, se puede notar que:
                     \[\frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(\mu - \sigma - \mu)^2}{2\sigma^2}} = \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(\mu + \sigma - \mu)^2}{2\sigma^2}}\]
                     \[ \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(- \sigma)^2}{2\sigma^2}} = \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(\sigma)^2}{2\sigma^2}}\]
                     Entonces por definicion de punto de inflexion, si uno es  punto de inflexion, el otro lo es tambien. De donde la segunda derivada de f(x) es:
                     \[\sigma\frac{(2x^2-4\mu x + 2\mu^2 + 1)e^{(x-\mu)^2}}{\sqrt{2\pi}}\]
                     Donde solo es igual a 0 cuando $x = \mu - \sigma$. Por definicion de punto de inflexion, tambien cuando $x= \mu + \sigma$.
				}
